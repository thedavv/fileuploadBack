...
import com.racek.service.StorageService;
...
public class StorageController {
	@Autowired
	StorageServiceTemplate storageServiceTemplate;
	...
	public ResponseEntity<String> store(@RequestParam("file") MultipartFile file) {
		String message = "";
		try {
			storageServiceTemplate.store(file);
	...
	public ResponseEntity<Resource> getFile(@PathVariable String filename) {
		Resource file = storageServiceTemplate.loadFile(filename);
